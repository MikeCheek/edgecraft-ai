...
class CArrayGenerator:
    ...
    def binary_to_c_array(binary_data: bytes, model_name: str = "model") -> str:
        ...
        # Build the hex body directly with correct comma placement - the
        # previous version inserted "\n  " as a separate list element and
        # then joined everything with ", ", which produced an invalid
        # stray comma at every line break (e.g. "0x14, \n  , 0x1c").
        lines = []
        row = []
