...
# --- Singleton services ---
# NOTE: the old `Converter` service (app/services/converter.py) was a fake
# simulator - hardcoded sizes, hardcoded compression ratios, and a C array
# filled with placeholder bytes unrelated to any real model. It has been
# removed. All optimization/export now flows through app/services/optimizer.py
# (real TFLite conversion + evaluation) and app/services/exporter.py
# (real C array / Arduino project generation from the actual model bytes).
